...
export default function NavbarComponent() {
  ...
  return (
    <Disclosure as="nav" className="dark:bg-gray-800 bg-white fixed w-full top-0">
      {({ open }) => (
        <>
                      ...
                      <Link
                        ...
                        className={`${
                          item.current
                            ...
                            : "dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white hover:bg-gray-100 hover:text-gray-900 text-slate-800"
